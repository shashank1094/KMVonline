...
public class CollegeNotificationDetail extends AppCompatActivity  {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.detail_delete:
                AlertDialog.Builder builder = new AlertDialog.Builder(CollegeNotificationDetail.this);
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (networkInfo != null && networkInfo.isConnected()) {
                                    ...
                                    Toast.makeText(CollegeNotificationDetail.this,"No internet. Try after some time.",Toast.LENGTH_SHORT).show();
                                }
                            }
                        })
    ...
    private class deleteNow extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String response) {
            if (response.length()<1)
                Toast.makeText(CollegeNotificationDetail.this,"Try after some time.",Toast.LENGTH_SHORT).show();
            if(response.charAt(0)=='1')
                Toast.makeText(CollegeNotificationDetail.this,"Deleted",Toast.LENGTH_SHORT).show();
            else
                Toast.makeText(CollegeNotificationDetail.this,"Try after some time.",Toast.LENGTH_SHORT).show();
            startActivity(new Intent(CollegeNotificationDetail.this,LoginActivity.class));
        }
        @Override
