...
/**
 * Created by shashank on 05-Dec-16.
 */

public class InputCollegeNotification extends AppCompatActivity{
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    Toast.makeText(InputCollegeNotification.this,"No internet. Try after some time.",Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void saving(){
        hideKeyboard();
        progressDialog= new ProgressDialog(InputCollegeNotification.this,
        ...
        if(flag==1) {
            ...
            SharedPreferences sharedPreferences = InputCollegeNotification.this.getSharedPreferences(Config.SHARED_PREF_NAME_LOGIN_DETAILS, Context.MODE_PRIVATE);
    ...
    private void backPressed(){
        ...
        {
            AlertDialog.Builder builder = new AlertDialog.Builder(InputCollegeNotification.this);
    ...
    private class saveClicked extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String response) {
            if(response.length()<1)
                Toast.makeText(InputCollegeNotification.this,"Not Saved. Try after some time.",Toast.LENGTH_SHORT).show();
            if(response.charAt(0)=='1') {
                Toast.makeText(InputCollegeNotification.this, "Saved", Toast.LENGTH_SHORT).show();
                CollegeNotificationSyncAdapter.syncImmediately(InputCollegeNotification.this);
                onBackPressed();
            }
            else
                Toast.makeText(InputCollegeNotification.this,"Not Saved. Try after some time.",Toast.LENGTH_SHORT).show();
